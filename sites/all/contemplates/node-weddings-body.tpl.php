<?php 
global $base_url; 
$venue = node_load($node->field_weddingvenue[0]['nid']);

foreach ($node->field_spaces as $space) {
	if (strlen($space['value']['field_space_description'][0]['value']) != 0) {
		$spaces[] = $space;
	} 
}
?>
<div id="subnav">
		<h1>Weddings and <br />conferences</h1>
		  <ul id="cats">
		  <li><a href="http://www.visitlichfield.org.uk/type/weddings/category/all" class="cat1 selected">Weddings</a></li>
		  <li><a href="http://www.visitlichfield.org.uk/type/conferences/category/all" class="cat2">Conferences</a></li>
		  </ul></div>
<div id="itemview">
<a href="http://www.visitlichfield.co.uk/type/weddings/category/all" class="return">&lt; Return to list</a>

<h2><?php echo nl2p(check_plain($node->title)); ?></h2>
<div id="desc">
...
?>
<h3 class="head"><span></span>Wedding planning service</h3>
<div class="panel">
<?php
...
<?php
if (strlen($node->field_catering[0]['value']) > 0 || strlen($node->field_food[0]['value']) > 0) {
?>
...
<div class="panel">
<?php
if ($node->field_weddingvenue[0]['nid'] == NULL) {
...
cck_listview("Facilities", $space['value']['field_space_facilities']);
