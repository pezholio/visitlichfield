...
<h1>Events</h1>
		<ul id="cats">
		  <li><a href="http://www.visitlichfield.co.uk/type/events/this-month" class="cat1">This month</a></li>
		  <li><a href="http://www.visitlichfield.co.uk/type/events/this-week" class="cat2">This week</a></li>
		  <li><a href="http://www.visitlichfield.co.uk/type/events/this-week" class="cat3 selected">View all</a></li>
		  </ul>
  <form action="" accept-charset="UTF-8" method="get" id="views-exposed-form-Events-page-1" class="events">
