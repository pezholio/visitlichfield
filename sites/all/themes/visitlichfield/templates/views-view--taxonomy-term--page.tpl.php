...
?>
<ul id="cats">
<li><a href="http://www.visitlichfield.co.uk/type/weddings/category/all" class="cat1 selected">Weddings</a></li>
<li><a href="http://www.visitlichfield.co.uk/type/conferences/category/all" class="cat2">Conferences</a></li>
</ul>
<?php
} elseif ($view->args[0] == "conferences") {
?>
<ul id="cats">
<li><a href="http://www.visitlichfield.co.uk/type/weddings/category/all" class="cat1">Weddings</a></li>
<li><a href="http://www.visitlichfield.co.uk/type/conferences/category/all" class="cat2 selected">Conferences</a></li>
</ul>
<?php
} 
?>
...
<p><a href="<?php echo $view->args[1]; ?>/map">View on map</a></p>
  <?php
  global $user;
  if ($user->uid == 1) {
  ?>
