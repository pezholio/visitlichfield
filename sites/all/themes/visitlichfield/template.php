...
function visitlichfield_views_pre_execute(&$view) {
 ...
 */
function visitlichfield_theme(&$existing, $type, $theme, $path) {
...
function visitlichfield_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function visitlichfield_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function visitlichfield_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function visitlichfield_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
