...
<div id="itemview">
<a href="http://www.enjoyeaststaffs.co.uk/type/accommodation/category/all" class="return">&lt; Return to list</a>
...
foreach ($node->field_access_stair_areas as $stair) {
	if (strlen($stair['value']) > 0) {
		$stairs[] = $stair['value'];
	}
}
